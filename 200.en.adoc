...
(For real-time data on private sector publishers, please refer to https://www.gbif.org/composition/1XtRfS0nTKs8HtRd18Q7ai/businesses-sharing-biodiversity-data-via-gbif[GBIF.org/business].)
