...
tt %>%  
mutate(`Datasets` = format(`Datasets`, nsmall=0, big.mark="U+202F")) %>%
mutate(`Occurrence records` = format(`Occurrence records`, nsmall=0, big.mark="U+202F")) %>%
mutate(`Data citations` = format(`Data citations`, nsmall=0, big.mark="U+202F")) 
